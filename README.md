...
## Commits
deployed version of challenge: https://pensive-wing-940cef.netlify.app/
...
> Answer: Client side routing routes all of your pages locally on your machine on the (react) DOM, no auto page refresh.
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML. 
- [ ] What are `controlled components` in React?
> Answer: Controlled components in React are values driven by React, a synced state with input value.
